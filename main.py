...
with open("Helpless/settings.json") as f:
...
async def on_guild_channel_create(channel):
    try:
       webhook = await channel.create_webhook(name="AAAAAH DO YOU NEED HELP?")
       for i in range(120):
...
██║░░██║██║░░██║██║░░██║
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝
Made By SuperVladimir#3912
Github: https://github.com/flyingndcoding     
I am not responsible if any wrong happens its made for educational purposes only!
